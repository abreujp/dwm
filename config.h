...
static const char *fonts[]          = { "CaskaydiaMono Nerd Font Mono:style=bold:size=10:antialias=true:autohint=true", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true" };
